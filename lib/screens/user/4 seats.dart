...
class Booking4Seats extends StatefulWidget {
  final String tableId;

  Booking4Seats({required this.tableId});

  @override
  _Booking4SeatsState createState() => _Booking4SeatsState();
}

class _Booking4SeatsState extends State<Booking4Seats> {
