...
class Booking6Seats extends StatefulWidget {
  final String tableId;

  Booking6Seats({required this.tableId});

  @override
  _Booking6SeatsState createState() => _Booking6SeatsState();
}

class _Booking6SeatsState extends State<Booking6Seats> {
