...
class Tablet2Bookings extends StatefulWidget {
  const Tablet2Bookings({super.key});

  @override
  State<Tablet2Bookings> createState() => _Tablet2BookingsState();
}

class _Tablet2BookingsState extends State<Tablet2Bookings> {
